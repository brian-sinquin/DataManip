...
class DataTableView(QTableView):
    ...
    def _on_column_removed(self, name: str, index: int) -> None:
        """Handle column removed signal.
        
        Args:
            name: Name of removed column
            index: Index of removed column
        """
    ...
    def edit_column(self, column_name: str):
        ...
        if metadata.is_data_column():
            from .dialogs import AddDataColumnDialog
            ...
            from .dialogs import AddCalculatedColumnDialog
            ...
            from .dialogs import AddDerivativeColumnDialog
            ...
            from .dialogs import AddRangeColumnDialog
            ...
            from .dialogs import AddInterpolationColumnDialog
    ...
    def _show_add_uncertainty_column_dialog(self):
        ...
        from .dialogs import AddUncertaintyColumnDialog
